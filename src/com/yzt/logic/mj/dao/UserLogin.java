...
public class UserLogin {
	 ...
	 * @return
	 */
	public static Player getUserInfoByOpenId(String openId,String cid) {
		try {
			String sendGet = sendGet(Cnst.GETUSER_URL, "openId=" + openId + "&cId=" +cid);
            ...
            log.error("UserLogin的getUserInfoByOpenId数据库报错",e);
		}
	...
	public static String sendGet(String url, String param) {
		...
		try {
            ...
            log.error("UserLogin的sendGet数据库报错");
		}
		// 使用finally块来关闭输入流
		finally {
			try {
